...
export const WelcomeBackEmail = ({
  ...
  return (
    <Html>
      <Head>
        <title>Welcome Back to University Library</title>
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:wght@400;500;600;700&display=swap"
        />
      </Head>
      <Preview>Welcome back to University Library, {fullName}!</Preview>
          ...
          <Section style={styles.mainCard}>
            <Section style={styles.cardContent}>
              ...
              <Text style={styles.welcomeText}>
                We're delighted to see you back at the University Library. Your
                continued engagement with our resources helps us create a better
              ...
              <Section style={styles.statusBox}>
                <Row>
                  <Column style={{ width: "42px", verticalAlign: "middle" }}>
                    <Img
                      src="https://raw.githubusercontent.com/simple-icons/simple-icons/develop/icons/checkmarx.svg"
                      width="24"
                      height="24"
                      alt="Active Account"
                      style={{
                  ...
                  <Column style={{ verticalAlign: "middle" }}>
                    ...
                    <Text style={styles.statusText}>
                      Your library account is fully active with access to all
                      our resources, services, and exclusive member benefits.
                    </Text>
                  </Column>
                </Row>
              </Section>
              ...
              <Section style={styles.featuresSection}>
                ...
                <Row style={styles.featureRow}>
                  <Column style={styles.featureCol}>
                    <Section style={styles.featureBox}>
                      <Img
                        src="https://raw.githubusercontent.com/tabler/tabler-icons/master/icons/search.svg"
                        width="32"
                        height="32"
                        alt="Improved Search"
                        style={styles.featureIcon}
                      />
                      <Text style={styles.featureTitle}>Improved Search</Text>
                  ...
                  <Column style={styles.featureCol}>
                    <Section style={styles.featureBox}>
                      <Img
                        src="https://raw.githubusercontent.com/tabler/tabler-icons/master/icons/bulb.svg"
                        width="32"
                        height="32"
                ...
                <Row style={styles.featureRow}>
                  <Column style={styles.featureCol}>
                    <Section style={styles.featureBox}>
                      <Img
                        src="https://raw.githubusercontent.com/tabler/tabler-icons/master/icons/calendar-time.svg"
                        width="32"
                        height="32"
                        alt="Extended Borrowing"
                        style={styles.featureIcon}
                      />
                      ...
                      <Text style={styles.featureText}>
                        Longer checkout periods for all students
                      </Text>
                    </Section>
                  </Column>
                  <Column style={styles.featureCol}>
                    <Section style={styles.featureBox}>
                      <Img
                        src="https://raw.githubusercontent.com/tabler/tabler-icons/master/icons/armchair.svg"
                        width="32"
                        height="32"
                        alt="Study Spaces"
                        style={styles.featureIcon}
                      />
                      <Text style={styles.featureTitle}>New Study Spaces</Text>
                      <Text style={styles.featureText}>
                        Modern spaces with comfortable furniture
                      </Text>
                    </Section>
                  </Column>
                </Row>
              ...
              <Text style={styles.footerMessage}>
                If you have questions about our new features, please contact our
                support team at{" "}
