...
export const WelcomeEmail = ({
  ...
  return (
    <Html>
      ...
      <Preview>Welcome to University Library, {fullName}!</Preview>
          ...
          <Section style={styles.mainCard}>
            <Section style={styles.cardContent}>
              ...
              <Text style={styles.welcomeText}>
                Thank you for joining our community of book lovers and lifelong
                learners. Your account has been created and is now pending
              ...
              <Section style={styles.statusBox}>
                <Row>
                  <Column style={{ width: "42px", verticalAlign: "middle" }}>
                    <Img
                      src="https://raw.githubusercontent.com/simple-icons/simple-icons/develop/icons/clockify.svg"
                      width="24"
                      height="24"
                      alt="Clock"
                      style={{
                  ...
                  <Column style={{ verticalAlign: "middle" }}>
                    ...
                    <Text style={styles.statusText}>
                      ...
                      {universityId
                        ...
                        : ""}{" "}
                      and university card. You'll receive an email once
                      approved.
                    </Text>
                  </Column>
                </Row>
              ...
              <Section style={styles.featuresSection}>
                ...
                <Row style={styles.featureRow}>
                  <Column style={styles.featureCol}>
                    <Section style={styles.featureBox}>
                      <Img
                        src="https://raw.githubusercontent.com/tabler/tabler-icons/master/icons/books.svg"
                        width="32"
                        height="32"
                        alt="Book Collection"
                      ...
                      <Text style={styles.featureText}>
                        Access thousands of books, journals, and research
                        materials
                      </Text>
                    </Section>
                  </Column>
                  <Column style={styles.featureCol}>
                    <Section style={styles.featureBox}>
                      <Img
                        src="https://raw.githubusercontent.com/tabler/tabler-icons/master/icons/calendar.svg"
                        width="32"
                        height="32"
                        alt="Easy Borrowing"
                        style={styles.featureIcon}
                      ...
                      <Text style={styles.featureText}>
                        Borrow and return with just a few clicks
                      </Text>
                    </Section>
                  </Column>
                </Row>
                ...
                <Row style={styles.featureRow}>
                  <Column style={styles.featureCol}>
                    <Section style={styles.featureBox}>
                      <Img
                        src="https://raw.githubusercontent.com/tabler/tabler-icons/master/icons/bell.svg"
                        width="32"
                        height="32"
                      ...
                      <Text style={styles.featureText}>
                        Get reminders for due dates and new arrivals
                      </Text>
                    </Section>
                  </Column>
                  <Column style={styles.featureCol}>
                    <Section style={styles.featureBox}>
                      ...
                      <Text style={styles.featureText}>
                        Find any title with our powerful search tools
                      </Text>
                    </Section>
                  </Column>
                </Row>
